#script to perform bayesian sensitibity analysis in R using the LearnBayes package and the hearttransplants dataset provided there

#all the libraries are here
 library(LearnBayes)

 #all the data importation happens here
...
############# does posterior on true rates depend on prior? does it?
